...
return [
	...
	'view_replace_str'  =>  [
		...
		'__ADDONS__' => __ROOT__.'/static/kashu/addons',
		'__IMG__'    =>__ROOT__.'/static/kashu/images',
		'__CSS__'    => __ROOT__.'/static/kashu/css',
		'__JS__'     => __ROOT__.'/static/kashu/js',
	],
		// +----------------------------------------------------------------------
		// | 模板设置
		// +----------------------------------------------------------------------
		...
		'template'               => [
				...
				'type'         => 'Think',
				// 模板路径
 				'view_path'    => APP_PATH.'kashu/view/default/',
				// 模板后缀
				'view_suffix'  => 'html',
				// 模板文件名分隔符
				'view_depr'    => DS,
